...
# Install the Step Recorder plugin from this repository
appium plugin install inspector --source=git --package=git+https://github.com/LevanKerdikashvili/appium-inspector-step-recorder.git
